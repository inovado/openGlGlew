...
int main()
{
	...
	mainLight = Light(1.0f, 1.0f, 1.0f, 0.2f, 2.0f, -1.0f, -2.0f, 1.0f); // Inicializacion de luz con otros parametros

	GLuint uniformProjection = 0, uniformModel = 0, uniformView = 0, uniformAmbientIntensity = 0, uniformAmbientColour = 0, uniformDirecion = 0, uniformDiffuseIntensity = 0;
